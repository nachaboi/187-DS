...
//	@Test
//	public void testNathanTest() throws Exception {
//		Queue<Integer> q = new Queue<Integer>();
//		q.enqueue(1);
//		q.enqueue(2);
//		q.enqueue(3);
//		q.enqueue(4);
//		Queue<Integer> samp = (Queue<Integer>) q.reversed();
//		assertEquals("4321", samp.daString());
//		q.dequeue();
//		samp = (Queue<Integer>) q.reversed();
//
//		assertEquals("432", samp.daString());
//		assertEquals(3, q.size());
//		
//		UnboundedQueueInterface<Integer> r;
//		r = new Queue<Integer>(q);
//		r.dequeue();
//		Queue<Integer> testa = (Queue<Integer>) r.reversed();
//		assertEquals("43", testa.daString());
//	}
