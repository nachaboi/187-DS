...
public class PublicLinkedSetTest {
  ...
  public void before() {
    ...
    setNathan = new LinkedSet<String>();
    for(String e : new String[] {"c"}) {
    	setNathan = setNathan.adjoin(e);
    }
  ...
  @Test
  public void testIteratorNathan() {
	  int count = 0;
	    for (String e : setNathan) {
	      count += 1;
	    }
