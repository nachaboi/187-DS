...
//	@Test
//	public void testNathanUpdateTest() {
//		gamerA.reset();
//		// ground truth number is 3242
//		assertEquals("gamerA first guess", 1000, gamerA.getGuess());
//		assertTrue("gamerA first update", gamerA.updateGuess(3));
//		
//		assertEquals("gamerA second guess", 1001, gamerA.getGuess());
//		assertTrue("gamerA second update", gamerA.updateGuess(0));
//		
//		assertEquals("gamerA third guess", 3222, gamerA.getGuess());
//		assertTrue("gamerA third update", gamerA.updateGuess(3));
...
//	}
	...
	@Test
	public void testnumMatchesNathan() {
		
		assertEquals(0, LinkedListGame.numMatches(1234, 5678));
	}
